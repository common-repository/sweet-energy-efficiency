...
class Graph_m extends Winter_MVC_Model {

	public $_table_name = 'see_graph';
	public $_order_by = 'idgraph DESC';
    public $_primary_key = 'idgraph';
	...
	public function __construct(){
        ...
        //$this->form_admin = array(
         //   'listing_id' => array('field'=>'listing_id', 'label'=>__('Listing', 'sweet-energy-efficiency'), 'design'=>'dropdown_listing', 'rules'=>'trim|callback__calendar_exists|required')
        //);
	}
